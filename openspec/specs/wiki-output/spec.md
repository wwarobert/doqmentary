# wiki-output Specification

## Purpose

Define how approved section content is assembled into a navigable, linked multi-page wiki document with a synthesized home page, a pluggable navigation manifest, and cross-link integrity.
