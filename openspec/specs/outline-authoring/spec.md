# outline-authoring Specification

## Purpose

Define how the author skill produces content for the configured sections, distinguishing fixed from variable blocks, synthesizing the Summary from the body, and ingesting source deck text.
